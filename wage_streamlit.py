...
jp_lat_lon = jp_lat_lon.rename(
    columns={'pref_name': '都道府県名'})
...
# df_ts_mean と　df_pref_meanを結合していく。
df_mean_line = pd.merge(
    df_ts_mean,
    df_pref_mean,
    on='集計年',
)
...
df_mean_categ = df_jp_category[
    (df_jp_category['集計年'] == option_year)
]
